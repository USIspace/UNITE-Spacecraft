...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/fat_file_sys/option/syscall.o: fat_file_sys/option/syscall.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/fat_file_sys/option" 
	@${RM} ${OBJECTDIR}/fat_file_sys/option/syscall.o.d 
	@${RM} ${OBJECTDIR}/fat_file_sys/option/syscall.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  fat_file_sys/option/syscall.c  -o ${OBJECTDIR}/fat_file_sys/option/syscall.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/fat_file_sys/option/syscall.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_XC16_24FJ256GA110=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -I"mcc_generated_files" -I"fat_file_sys" -I"fat_file_sys/option" -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/fat_file_sys/option/syscall.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/fat_file_sys/option/unicode.o: fat_file_sys/option/unicode.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/fat_file_sys/option" 
	@${RM} ${OBJECTDIR}/fat_file_sys/option/unicode.o.d 
	@${RM} ${OBJECTDIR}/fat_file_sys/option/unicode.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  fat_file_sys/option/unicode.c  -o ${OBJECTDIR}/fat_file_sys/option/unicode.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/fat_file_sys/option/unicode.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_XC16_24FJ256GA110=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -I"mcc_generated_files" -I"fat_file_sys" -I"fat_file_sys/option" -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/fat_file_sys/option/unicode.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/fat_file_sys/diskio.o: fat_file_sys/diskio.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/fat_file_sys" 
	@${RM} ${OBJECTDIR}/fat_file_sys/diskio.o.d 
	@${RM} ${OBJECTDIR}/fat_file_sys/diskio.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  fat_file_sys/diskio.c  -o ${OBJECTDIR}/fat_file_sys/diskio.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/fat_file_sys/diskio.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_XC16_24FJ256GA110=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -I"mcc_generated_files" -I"fat_file_sys" -I"fat_file_sys/option" -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/fat_file_sys/diskio.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/fat_file_sys/ff.o: fat_file_sys/ff.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/fat_file_sys" 
	@${RM} ${OBJECTDIR}/fat_file_sys/ff.o.d 
	@${RM} ${OBJECTDIR}/fat_file_sys/ff.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  fat_file_sys/ff.c  -o ${OBJECTDIR}/fat_file_sys/ff.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/fat_file_sys/ff.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_XC16_24FJ256GA110=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -I"mcc_generated_files" -I"fat_file_sys" -I"fat_file_sys/option" -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/fat_file_sys/ff.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
