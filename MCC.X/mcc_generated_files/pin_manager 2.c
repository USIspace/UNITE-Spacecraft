...
void PIN_MANAGER_Initialize(void)
{
    ...
    RPOR8bits.RP17R = 0x0006;   //RF5->UART2:U2RTS;
    RPOR13bits.RP26R = 0x0004;   //RG7->UART1:U1RTS;
    RPOR13bits.RP27R = 0x0003;   //RG9->UART1:U1TX;
    RPOR2bits.RP4R = 0x001D;   //RD9->UART3:U3RTS;
    RPINR27bits.U4CTSR = 0x0018;   //RD1->UART4:U4CTS;
    RPOR11bits.RP23R = 0x001F;   //RD2->UART4:U4RTS;
    RPOR15bits.RP30R = 0x0005;   //RF2->UART2:U2TX;
    RPINR19bits.U2RXR = 0x0010;   //RF3->UART2:U2RX;
    RPINR19bits.U2CTSR = 0x000A;   //RF4->UART2:U2CTS;
    RPINR18bits.U1CTSR = 0x0015;   //RG6->UART1:U1CTS;
    RPINR18bits.U1RXR = 0x0013;   //RG8->UART1:U1RX;
    RPOR6bits.RP12R = 0x001C;   //RD11->UART3:U3TX;
    RPINR21bits.U3CTSR = 0x0002;   //RD8->UART3:U3CTS;
